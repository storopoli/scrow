...
export function create_dispute_address(
  ...
  try {
    ...
    const ret = wasm.create_dispute_address(
      ptr0,
      len0,
      ptr1,
      len1,
...
export function create_collab_tx(
  ...
  npub_2,
  escrow_amount,
  resolution_address_1p,
  resolution_address_2p,
  funding_txid,
  fee,
  network,
) {
  ...
  try {
    ...
    const ret = wasm.create_collab_tx(
      ptr0,
      len0,
      ptr1,
      len1,
...
export function create_dispute_tx(
  ...
  try {
    ...
    const ret = wasm.create_dispute_tx(
      ptr0,
      len0,
      ptr1,
      len1,
...
export function new_dispute_unlocking_script_wasm(
  ...
  try {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.new_dispute_unlocking_script_wasm(
      ptr0,
      len0,
      ptr1,
      len1,
...
export function combine_signatures_collaborative_wasm(
  ...
  try {
    ...
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.combine_signatures_collaborative_wasm(
      ptr0,
      len0,
      index,
      ptr1,
...
export function combine_signatures_dispute_collaborative_wasm(
  ...
  try {
    ...
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.combine_signatures_dispute_collaborative_wasm(
      ptr0,
      len0,
      index,
      ptr1,
...
export function combine_signatures_dispute_arbitrator_wasm(
  ...
  try {
    ...
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.combine_signatures_dispute_arbitrator_wasm(
      ptr0,
      len0,
      index,
      ptr1,
