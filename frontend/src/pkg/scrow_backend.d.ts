 ...
 */
export function create_collab_address(npub_1: string, npub_2: string, network: string): string;
/**
 * Creates a 2-of-2/2-of-3 multisig escrow address for collaboration/dispute between two/three users,
 * the timelock duration,
 * and their respective Nostr public keys.
 */
export function create_dispute_address(npub_1: string, npub_2: string, npub_arbiter: string, timelock_duration: number, network: string): string;
/**
 ...
 */
export function create_collab_tx(npub_1: string, npub_2: string, escrow_amount: bigint, resolution_address_1p: string, resolution_address_2p: string, funding_txid: string, fee: bigint, network: string): string;
/**
 ...
 * The user should also specify the funding [`Txid`] that assumes the vout is always 0.
 */
export function create_dispute_tx(npub_1: string, npub_2: string, npub_arbiter: string, escrow_amount: bigint, resolution_address_1p: string, resolution_address_2p: string, funding_txid: string, fee: bigint, timelock_duration: number, network: string): string;
 ...
 * If using MutinyNet, the host MUST be `https://mutinynet.com`
 */
export function push_transaction(host: string, endpoint: string, tx_hex: string): Promise<any>;
...
export function convert_days_hours_to_blocks_wasm(days: number, hours: number): number;
/**
 ...
 */
export function pub_key_derivation_to_sign_wasm(nsec: string, network: string): string;
/**
 ...
 */
export function new_dispute_unlocking_script_wasm(npub: string[], npub_arbitrator: string, timelock_duration: number): string;
/**
 ...
 */
export function sign_tx_wasm(tx: string, index: number, nsec: string, amount: bigint, unlocking_script: string, network: string): string;
export function combine_signatures_collaborative_wasm(tx: string, index: number, signatures: string[], npubs: string[], unlocking_script: string): string;
export function combine_signatures_dispute_collaborative_wasm(tx: string, index: number, signatures: string[], npubs: string[], unlocking_script: string): string;
export function combine_signatures_dispute_arbitrator_wasm(tx: string, index: number, signatures: string[], npubs: string[], unlocking_script: string): string;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
  readonly memory: WebAssembly.Memory;
  readonly create_collab_address: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
  readonly create_dispute_address: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
  readonly create_collab_tx: (a: number, b: number, c: number, d: number, e: bigint, f: number, g: number, h: number, i: number, j: number, k: number, l: bigint, m: number, n: number) => [number, number];
  readonly create_dispute_tx: (a: number, b: number, c: number, d: number, e: number, f: number, g: bigint, h: number, i: number, j: number, k: number, l: number, m: number, n: bigint, o: number, p: number, q: number) => [number, number];
  readonly greet: (a: number, b: number) => [number, number];
  readonly fetch_fees: (a: number, b: number, c: number, d: number) => any;
  readonly push_transaction: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
  ...
  readonly convert_nsec_to_hex_wasm: (a: number, b: number, c: number, d: number) => [number, number];
  readonly pub_key_derivation_to_sign_wasm: (a: number, b: number, c: number, d: number) => [number, number];
  readonly convert_npub_to_hex_wasm: (a: number, b: number) => [number, number];
  readonly new_collaborative_unlocking_script_wasm: (a: number, b: number) => [number, number];
  readonly new_dispute_unlocking_script_wasm: (a: number, b: number, c: number, d: number, e: number) => [number, number];
  readonly sign_tx_wasm: (a: number, b: number, c: number, d: number, e: number, f: bigint, g: number, h: number, i: number, j: number) => [number, number];
  readonly combine_signatures_collaborative_wasm: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
  readonly combine_signatures_dispute_collaborative_wasm: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
  readonly combine_signatures_dispute_arbitrator_wasm: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number];
  ...
  readonly closure228_externref_shim: (a: number, b: number, c: any, d: any) => void;
